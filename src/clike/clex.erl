...
-file("/Users/luke/work/sicp_env/src/clike/clex.xrl", 27).
...
-file("/Users/luke/work/sicp_env/src/clike/clex.erl", 311).
yystate() -> 30.
...
yystate(34, [10|Ics], Line, Tlen, _, _) ->
    yystate(34, Ics, Line+1, Tlen+1, 11, Tlen);
...
yystate(30, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(1, Ics, Line, Tlen+1, Action, Alen);
yystate(30, [C|Ics], Line, Tlen, Action, Alen) when C >= 98, C =< 100 ->
    yystate(1, Ics, Line, Tlen+1, Action, Alen);
yystate(30, [C|Ics], Line, Tlen, Action, Alen) when C >= 106, C =< 110 ->
    yystate(1, Ics, Line, Tlen+1, Action, Alen);
yystate(30, [C|Ics], Line, Tlen, Action, Alen) when C >= 112, C =< 115 ->
    yystate(1, Ics, Line, Tlen+1, Action, Alen);
...
yystate(27, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(1, Ics, Line, Tlen+1, 8, Tlen);
yystate(27, [C|Ics], Line, Tlen, _, _) when C >= 98, C =< 116 ->
    yystate(1, Ics, Line, Tlen+1, 8, Tlen);
...
yystate(26, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 33 ->
    yystate(18, Ics, Line, Tlen+1, 2, Tlen);
yystate(26, [C|Ics], Line, Tlen, _, _) when C >= 35 ->
    yystate(18, Ics, Line, Tlen+1, 2, Tlen);
...
yystate(10, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(18, Ics, Line, Tlen+1, Action, Alen);
yystate(10, [C|Ics], Line, Tlen, Action, Alen) when C >= 11 ->
    yystate(18, Ics, Line, Tlen+1, Action, Alen);
...
-file("/Users/luke/work/sicp_env/src/clike/clex.xrl", 9).
yyaction_0(TokenChars, TokenLine) ->
     { token, { num_val, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_1/2}).
-file("/Users/luke/work/sicp_env/src/clike/clex.xrl", 10).
yyaction_1(TokenChars, TokenLine) ->
     { token, { num_val, TokenLine, list_to_float (TokenChars) } } .

-compile({inline,yyaction_2/3}).
-file("/Users/luke/work/sicp_env/src/clike/clex.xrl", 11).
yyaction_2(TokenChars, TokenLen, TokenLine) ->
     { token, { str_val, TokenLine, strip (TokenChars, TokenLen) } } .

-compile({inline,yyaction_3/2}).
-file("/Users/luke/work/sicp_env/src/clike/clex.xrl", 12).
yyaction_3(TokenChars, TokenLine) ->
     { token, { bool_val, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_4/2}).
-file("/Users/luke/work/sicp_env/src/clike/clex.xrl", 14).
yyaction_4(TokenChars, TokenLine) ->
     { token, { equal_exp, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_5/2}).
-file("/Users/luke/work/sicp_env/src/clike/clex.xrl", 15).
yyaction_5(TokenChars, TokenLine) ->
     { token, { add_exp, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_6/2}).
-file("/Users/luke/work/sicp_env/src/clike/clex.xrl", 16).
yyaction_6(TokenChars, TokenLine) ->
     { token, { mul_exp, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_7/2}).
-file("/Users/luke/work/sicp_env/src/clike/clex.xrl", 17).
yyaction_7(TokenChars, TokenLine) ->
     { token, { list_to_atom (TokenChars), TokenLine } } .

-compile({inline,yyaction_8/2}).
-file("/Users/luke/work/sicp_env/src/clike/clex.xrl", 19).
yyaction_8(TokenChars, TokenLine) ->
     { token, { var_exp, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_9/1}).
-file("/Users/luke/work/sicp_env/src/clike/clex.xrl", 20).
yyaction_9(TokenLine) ->
     { token, { end_exp, TokenLine } } .

-compile({inline,yyaction_10/0}).
-file("/Users/luke/work/sicp_env/src/clike/clex.xrl", 21).
yyaction_10() ->
     skip_token .

-compile({inline,yyaction_11/0}).
-file("/Users/luke/work/sicp_env/src/clike/clex.xrl", 22).
yyaction_11() ->
     skip_token .
